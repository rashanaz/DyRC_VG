...
def figure_2a(data_path):
    ...
    for n in [100, 500]:
        ...
        name = f'N_{n}_alpha_0.5_skip_1_n_9'
        ...
        name = f'N_{n}_alpha_0.5_skip_16_n_9'
        adj = np.load(os.path.join(path, f'{name}_matrix_vg_reservoir.npy'))
    ...
    export_figure(fig, 
                    name=f'figure_2a_Lorenz_0025.png',
                    height=4.2,
                    width=8.5,
                    resolution=300)
    plt.show()
...
def figure_2b(data_path):
    ...
    export_figure(fig, 
                    name=f'figure_2b_Lorenz_0025.png',
                    height=5,
                    width=8.5,
                    resolution=300)
    plt.show()
